...
if (count($more_product_array) > 0) {
    ...
    <div class="container">		
        <div class="row rowhead">
            <div class="rowsub "><?php esc_html_e('Vendor', 'multivendorx'); ?></div>
            <div class="rowsub"><?php esc_html_e('Price', 'multivendorx'); ?></div>
            <div class="rowsub">
                <select name="mvx_multiple_product_sorting" id="mvx_multiple_product_sorting" class="mvx_multiple_product_sorting" attrid="<?php echo $post->ID; ?>" >
                    <option value="price"><?php esc_html_e('Price Low To High', 'multivendorx'); ?></option>
                    <option value="price_high"><?php esc_html_e('Price High To Low', 'multivendorx'); ?></option>
                    <option value="rating"><?php esc_html_e('Rating High To Low', 'multivendorx'); ?></option>
                    <option value="rating_low"><?php esc_html_e('Rating Low To High', 'multivendorx'); ?></option>
                </select>
            </div>
    ...
    <div class="container">
        <div class="row">
    <?php esc_html_e('Sorry no more offers available', 'multivendorx'); ?>
        </div>
    </div>	
<?php }
?>
