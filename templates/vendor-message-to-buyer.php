...
<table style="width:100%; color: #737373; border: 1px solid #e4e4e4; background:none;" border="0" cellpadding="8" cellspacing="0">
    ...
    foreach ($vendor_array as $vendor_id => $products) {
        if (is_user_mvx_vendor($vendor_id)) {
            ...
            if ($cc == 0) { ?>
                <tr>
                    <th style="padding:10px 10px; background:none; border-right: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; width:50%;" align="left" valign="top"><?php esc_html_e('Vendor Details', 'multivendorx'); ?></th>
                    <?php if( $vendor_message_to_buyer ) { ?>    
                        <th style="padding:10px 10px;width: 50%; border-bottom: 1px solid #e4e4e4;  background:none;" align="left" valign="top"><?php esc_html_e('Message', 'multivendorx'); ?></th>
                    <?php } ?>
                </tr>
            <?php } ?>
            <tr>
